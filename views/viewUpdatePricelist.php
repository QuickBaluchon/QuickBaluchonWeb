           ...
           <div class="row">
             <div class="col-lg">
                 ...
                 <form class="form-round">
                   <div class="form-group row">
                     <div class="col-sm-10">
                       ...
                       <input type="number" min="0.1" step="0.01" class="form-control" id="inputWeight" value="<?= $values['maxWeight'] ?>" disabled="true">
                     </div>
                   </div>
                   <div class="form-group row">
                     <div class="col-sm-10">
                       <label for="inputExpress">Prix Express</label>
                       <input type="number" min="0.1" step="0.01" class="form-control" id="ExpressPrice" value="<?= $values['ExpressPrice'] ?>">
                     </div>
                   </div>
                   <div class="form-group row">
                     <div class="col-sm-10">
                       <label for="inputStandard">Prix Standard</label>
                       <input type="number" min="0.1" step="0.01" class="form-control" id="StandardPrice" value="<?= $values['StandardPrice'] ?>">
                     </div>
                   </div>
                   <div class="form-group row">
                     <div class="col-sm-10">
                   ...
                   <div class="form-group row">
                     <div class="col-sm-10">
                       <button type="button" name="button" onclick="update(<?php echo $id ?>)">enregistrer</button>
                     </div>
                   </div>
                 </form>
               ...
               <div class="package-img col-5 d-flex flex-column justify-content-center">
                 <!-- IMAGE -->
                 <img class="d-lg-block mx-auto" src="../assets/package.png" alt="package">
               </div>
             </div>
           </div>
